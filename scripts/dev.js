...
const services = [
  ...
  { name: 'dispatch',     args: tsNodeCmd('dispatch-service', 'apps/dispatch-service/src/main.ts'),   env: { PORT: '3005' } },
  { name: 'tracking',     args: tsNodeCmd('tracking-service', 'apps/tracking-service/src/main.ts'),   env: { PORT: '3006' } },
  { name: 'payment',      args: tsNodeCmd('payment-service', 'apps/payment-service/src/main.ts'),   env: { PORT: '3007' } },
  { name: 'notification', args: tsNodeCmd('notification-service', 'apps/notification-service/src/main.ts'), env: { PORT: '3008' } },
  { name: 'cod',          args: tsNodeCmd('cod-service', 'apps/cod-service/src/main.ts'),           env: { PORT: '3018' } },
  { name: 'chat',         args: tsNodeCmd('chat-service', 'apps/chat-service/src/main.ts'),         env: { PORT: '3013' } },
  { name: 'search',       args: tsNodeCmd('search-service', 'apps/search-service/src/main.ts'),       env: { PORT: '3014' } },
  { name: 'ratings',      args: tsNodeCmd('rating-service', 'apps/rating-service/src/main.ts'),      env: { PORT: '3015' } },
  { name: 'tips',         args: tsNodeCmd('tip-service', 'apps/tip-service/src/main.ts'),           env: { PORT: '3016' } },
  { name: 'promos',       args: tsNodeCmd('promo-service', 'apps/promo-service/src/main.ts'),        env: { PORT: '3017' } },
